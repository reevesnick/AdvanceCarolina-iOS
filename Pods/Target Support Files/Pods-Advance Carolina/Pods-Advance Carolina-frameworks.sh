...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "Pods-Advance Carolina/ChameleonFramework.framework"
  ...
  install_framework "Pods-Advance Carolina/LaunchKit.framework"
  install_framework "Pods-Advance Carolina/MBProgressHUD.framework"
